...
def create_template() -> ContentTemplate:
    ...
    return ContentTemplate(
        ...
        sections=[
            ...
            TemplateSection(
                ...
                description=(
                    ...
                    "\n"
                    "【参考リンクのソース選定基準】\n"
                    "- 一次情報（当事者の公式発表・プレスリリース・公式ブログ）を最優先する\n"
                    "- 信頼できるメディア（大手ニュース、専門テックメディア、学術機関）のみ許可\n"
                    "- 個人ブログ・個人サイトの記事はソースとして使用しない\n"
                    "- 個人ブログ経由で知ったニュースでも、必ず原典を探してリンクする\n"
                    "\n"
        ...
        "タイトルは「【{年}年{月}月第{週}週】週刊AIニュースハイライト"
        " ― {トピック1}、{トピック2}、{トピック3}」の形式とする。"
